    ...
    switch (msg) {
      ...
      case "transmuxing_event": {
        ...
        if (packet.event == TransmuxingEvents.MEDIA_INFO) {
          const packet =
            message_packet as WorkerMessagePacketTransmuxingEventInfo;
          ...
          const packet =
            message_packet as WorkerMessagePacketTransmuxingEventRecommendSeekpoint;
      ...
      case "player_event": {
        ...
        if (packet.event == PlayerEvents.ERROR) {
          ...
          const packet =
            message_packet as WorkerMessagePacketPlayerEventExtraData;
